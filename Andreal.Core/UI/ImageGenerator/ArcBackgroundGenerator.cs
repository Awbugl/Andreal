...
internal class ArcBackgroundGenerator
{
    ...
    private async Task<BackGround> GenerateArcV1(Path path)
    {
        ...
        background.Draw(new ImageModel(Path.ArcaeaBg1Mask, 0, 0, 1440, 960), new ImageModel(masktmp, 50, 50, 1340, 860),
                        new ImageModel(Path.ArcaeaDivider, 100, 840, 1240), new TextWithStrokeModel("Pure", Font.Exo40, Color.White, 518, 488),
                        ...
                        new TextWithStrokeModel("Generated by Project Andreal", Font.KazesawaLight24, Color.White, 80, 865));
    ...
    private async Task<BackGround> GenerateArcV2(Path path)
    {
        ...
        background.FillColor(song.MainColor);
        background.Draw(new TextWithShadowModel("Play PTT", Font.Exo36, 123, 355), new TextWithShadowModel("Pure", Font.Exo32, 127, 455),
                        new TextWithShadowModel("Far", Font.Exo32, 127, 525), new TextWithShadowModel("Lost", Font.Exo32, 410, 525),
                        ...
                        new LineModel(Color.White, 3, new(0, 740), new(1920, 740)), new LineModel(Color.White, 3, new(0, 920), new(1920, 920)),
                        new LineModel(Color.White, 1, new(0, 705), new(1920, 705)), new LineModel(Color.White, 1, new(0, 955), new(1920, 955)),
                        new RectangleModel(Color.GetBySide(_info.Side), new(145, 685, 320, 320)), new ImageModel(song, 130, 670, 320, 320),
    ...
    private async Task<BackGround> GenerateArcV3(Path path)
    {
        ...
        background.Draw(new ImageModel(Path.ArcaeaBg3Mask(_info.Side), 0, 0, 1000),
                        new TextOnlyModel(_info.GetSongName(30), Font.Beatrice36, Color.Black, 500, 860, StringAlignment.Center),
                        new ImageModel(song, 286, 408, 428), new TextOnlyModel("PlayPtt:", Font.Exo24, Color.GnaqGray, 110, 1275),
                        new TextOnlyModel("PlayTime:", Font.Exo24, Color.GnaqGray, 110, 1355),
                        new TextOnlyModel("Pure", Font.Exo24, Color.Black, 635, 1260), new TextOnlyModel("Far", Font.Exo24, Color.Black, 635, 1315),
