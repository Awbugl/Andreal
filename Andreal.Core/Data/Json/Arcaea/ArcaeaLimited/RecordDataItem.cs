...
public class RecordDataItem
{
    ...
    [JsonProperty("shiny_pure_count")]
    public string ShinyPureCount { get; set; }

    [JsonProperty("pure_count")]
    public string PureCount { get; set; }

    [JsonProperty("far_count")]
    public string FarCount { get; set; }

    [JsonProperty("lost_count")]
    public string LostCount { get; set; }

    [JsonProperty("recollection_rate")]
