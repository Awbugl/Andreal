...
internal static class OtherApi
{
    ...
    internal static async Task<YcmResponse?> AddCarApi(
        string carType,
        string roomid,
        string description,
        long uin)
    ...
    {
        var jsonData = JsonConvert.DeserializeObject<BandoriRoomInfo>(await GetString("https://api.bandoristation.com/?function=query_room_number"));
